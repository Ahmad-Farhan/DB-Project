<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SC2_ViewAttendence.aspx.cs" Inherits="ViewAttendence" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="CourseInfo" style="border: 3px solid #0000FF">
            ...
            <p class="CourseSelect" >
                ...
                <asp:DropDownList ID="CourseList" runat="server" Width="50%" Height="70%" Font-Size="16pt" AutoPostBack="True" OnSelectedIndexChanged="CourseOptionSelected"></asp:DropDownList>
            </p>
        </div>
        <br><br /><br>
        <asp:GridView ID="AttendenceList" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None"
            ...
            <Columns>
                <asp:BoundField DataField="LectureNo" HeaderText="Lecture No." ItemStyle-HorizontalAlign="Center" />
