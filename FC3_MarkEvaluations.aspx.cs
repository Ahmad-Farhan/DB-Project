...
public partial class FC3_MarkEvaluations : System.Web.UI.Page
{
    ...
    static List<StudentMark> Students = new List<StudentMark>();
    ...
    {
        return ExecuteScalar("SELECT Student_Id FROM MARKS WHERE Student_Id = " + Students[0].User_Id + " AND Eval_Id = " + EvalIds[EvaluationList.SelectedIndex]);
    }
    ...
    {
        return "UPDATE MARKS SET AbsoluteScored = Obtained / " + EvalRange.Text + "*" + EvalWeightage.Text 
    ...
    private void ShowEvaluationDetails()
    {
        ...
        reader.Close();
        connection.Close();
        LogEvent("Marked Evaluations for Class");
    }
